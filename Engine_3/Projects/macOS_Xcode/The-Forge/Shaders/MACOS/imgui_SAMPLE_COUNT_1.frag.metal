...
fragment float4 imgui_SAMPLE_COUNT_1_frag(
	PS_INPUT In[[stage_in]]
	,Tex2D(float4) _fslF0_gTexture [[texture(0)]] // main arg PerBatch
)
#line 35
{
...
// INIT_MAIN;
 ...
 Out = In.col * SampleTex2D(gTexture, gSamplerBilinearClamp, In.uv);
# 50 "/Users/fabricio/Dev/TheForgeProject/The-Forge/Common_3/Application/UI/Shaders/FSL/ImGui.frag.fsl"
 {
 	return Out;
 }
#line 50
...
# 7 "/Users/fabricio/Dev/TheForgeProject/The-Forge/Common_3/Application/UI/Shaders/FSL/UIShaders.list" 2
