...
fragment float4 imgui_SAMPLE_COUNT_4_frag(
	PS_INPUT In[[stage_in]]
	,Tex2DMS(float4, 4) _fslF0_gTexture [[texture(0)]] // main arg PerBatch
)
#line 35
{
	Tex2DMS(float4, 4)  gTexture = _fslF0_gTexture;
...
# 17 "/Users/fabricio/Dev/TheForgeProject/The-Forge/Common_3/Application/UI/Shaders/FSL/UIShaders.list" 2
