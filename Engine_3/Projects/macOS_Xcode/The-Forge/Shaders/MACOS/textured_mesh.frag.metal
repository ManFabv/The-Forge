...
# 1 "/Users/fabricio/Dev/TheForgeProject/The-Forge/Common_3/Application/UI/Shaders/FSL/TexturedMesh.frag.fsl" 1
# 26 "/Users/fabricio/Dev/TheForgeProject/The-Forge/Common_3/Application/UI/Shaders/FSL/TexturedMesh.frag.fsl"
...
# 27 "/Users/fabricio/Dev/TheForgeProject/The-Forge/Common_3/Application/UI/Shaders/FSL/TexturedMesh.frag.fsl" 2
...
fragment float4 textured_mesh_frag(
	PsIn In[[stage_in]]
	,constant CBUFFER(TexturedConstants)& _fslF0_gUniformBlock [[buffer(4)]] // main arg PerDraw
	,Tex2D(float4) _fslF0_gTexture [[texture(0)]] // main arg PerDraw
)
#line 35
{
	constant CBUFFER(TexturedConstants)& gUniformBlock = _fslF0_gUniformBlock;
	Tex2D(float4)  gTexture = _fslF0_gTexture;
	In.position.w = rcp(In.position.w);

#line 37
// INIT_MAIN;
 float4 Out;
 Out = SampleTex2D(gTexture, gSamplerBilinearClamp, In.texcoord) * gUniformBlock.color;
 {
 	return Out;
 }
#line 40
...
# 36 "/Users/fabricio/Dev/TheForgeProject/The-Forge/Common_3/Application/UI/Shaders/FSL/UIShaders.list" 2
